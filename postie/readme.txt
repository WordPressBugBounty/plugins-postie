...
= 1.6.0 =
Remote cron jobs must update the URL to: http://<mysite>/?postie=get-mail. Accessing old get_mail.php will receive a 403 error and instruction. The Postie menu is now at the main level rather than a Settings submenu.
...
= 1.9.87 (2026-09-24) =
* Fix autolink issue
* minor changes to follow plugin guidelines
* Downgrade dependencies to be PHP 7+ compatible
...
= 1.9.81 (2026-08-13) =
* Prep for Wordpress 7.1

= 1.9.80 (2026-07-27) =
* Automatically self-heal/reschedule missing cron tasks on 'init' hook

= 1.9.79 (2026-07-20) =
* Provide better support for SSL connections to email server

= 1.9.78 (2026-07-08) =
* Revert changes that are not PHP 7.0 compatible
